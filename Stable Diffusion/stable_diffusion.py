...
print(f"QUESTION: {data[5000]['prompt']}\n")
print(f"ORIGINAL TEXT: {data[5000]['chosen']}\n")
print(f"SUMMARY TEXT: {summarize(openai_client, data[5000]['chosen'])}")
...
#     axes[(i*2)+1].set_title("Original Image")
#     axes[(i*2)+1].axis('off')
