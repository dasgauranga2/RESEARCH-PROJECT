...
root_dir = "."
input_file_name = f"./responses/{model_name}_results.json"
save_json_path_vd = f"./results/{model_name}_hallusion_output_vd_model.json"
save_json_path_vs = f"./results/{model_name}_hallusion_output_vs_model.json"
# load_json = False
load_json = True
...
if __name__ == "__main__":
    ...
    save_json_path = f"./results/{model_name}_eval_gpt4o.json"
    # save final results
