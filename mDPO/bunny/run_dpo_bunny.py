...
from data_collator_bunny_phi import mDPODataCollatorBunny, mDPOCNIDataCollatorBunny, mDPODCIDataCollatorBunny
from dpo_trainer import mDPOTrainer, mDPOCNITrainer, mDPODCITrainer
...
def train(config_dict):
    ...
    trainer = mDPODCITrainer(
        model, # model to be trained
        args=training_args,
        beta=training_args.beta,
        train_dataset=train_dataset,
        # eval_dataset=eval_dataset,
        data_collator=mDPODCIDataCollatorBunny(
            tokenizer,
            model,
