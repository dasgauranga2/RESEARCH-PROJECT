...
class CHAIR(object):
    ...
    def __init__(self, imids, coco_path, openai_apikey):
        ...
        #read in synonyms
        synonyms = open('Object Hal-Bench/synonyms_refine.txt').readlines()
...
'''
python Object\ Hal-Bench/obj_hb_eval.py --cap_file Object\ Hal-Bench/responses/bunny_results.jsonl --coco_path Object\ Hal-Bench/annotations/ --sample_num -1
'''
